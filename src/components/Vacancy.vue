    ...
    <div class="flipper">
      <div class="front">
        ...
        <div class="front__second-group">
          <button class="front__skip" @click.stop="$emit('skip')"></button>
          ...
          <button class="front__like" @click.stop="$emit('like')"></button>
        </div>
    </div>
    <div class="back">
...
.flipper {
  ...
  .front {
    ...
    &__skip {
      background-image: url('../../public/img/skip-btn.png');
      width: 60px;
      height: 60px;
    ...
    &__like {
      background-image: url('../../public/img/like-btn.png');
      width: 60px;
      height: 60px;
      background-size: contain;
      background-repeat: no-repeat;
